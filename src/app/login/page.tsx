...
import { Github, Mail, KeyRound, User, Eye, EyeOff } from "lucide-react";
    ...
    default:
      if (defaultMessage && defaultMessage.startsWith("Firebase: ")) {
        const friendlyPart = defaultMessage
          .substring("Firebase: ".length)
          .split(" (auth/")[0];
        return `Something went wrong: ${friendlyPart}. If this keeps happening, let us know!`;
      }
      return (
        defaultMessage || "An unexpected hiccup occurred. Please try again."
      );
  }
}
  ...
  const handleEmailPasswordSignUp = async (e: FormEvent) => {
    ...
    try {
      ...
      const newDisplayName =
        trimmedDisplayName || firebaseUser.email?.split("@")[0] || "User";
      ...
      toast({
        ...
        description: "Welcome to VoteCast! You're all set.",
      });
      const queryParams = new URLSearchParams(window.location.search);
      const redirect = queryParams.get("redirect");
      router.push(redirect || "/");
        ...
        <CardContent>
          <Tabs defaultValue="login" className="w-full">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <button
                      type="button"
                      aria-label={
                        showPasswordLogin ? "Hide password" : "Show password"
                      }
                      onClick={() => setShowPasswordLogin((v) => !v)}
                      className="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-accent focus:outline-none"
                      tabIndex={0}
                    >
                      {showPasswordLogin ? (
            ...
            <TabsContent value="signup">
              ...
              >
                <div className="space-y-2">
                  <Label htmlFor="displayName-signup">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <button
                      type="button"
                      aria-label={
                        showPasswordSignup ? "Hide password" : "Show password"
                      }
          ...
          >
            ...
            >
              ...
              <path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.13-3.13A11.944 11.944 0 0012 1 12.025 12.025 0 001.13 6.75l3.71 2.84c.87-2.6 3.3-4.53 6.16-4.53z" />
